            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "പൂജ തിരഞ്ഞെടുക്കുക",
                    style: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w700 , fontFamily: "NotoSansMalayalam"),
                  ),
                ),
                        ...
                        items: selectedCategoryId == null
                             ? [
                                DropdownMenuItem<int>(
                                  value: null,
                                  child: Text("Please select a god first", 
                                   style: TextStyle(color: Color.fromARGB(165, 158, 158, 158), fontWeight: FontWeight.w400),),
                                ),
                              ]
                             : poojasAsync!.when(
                              data: (poojas) => poojas.map(
                                  (pooja) => DropdownMenuItem<int>(
                                      value: pooja.id,
                                      child:Row(
                                          children: [
                                            Expanded(child: Text(pooja.name , overflow: TextOverflow.fade, maxLines: 1,)),
                                            SizedBox(width: 6.w),
                                            Text("₹${pooja.price}",)
                                          ],
                                        ),
                             ...
                             error: (err, _) => [
                                DropdownMenuItem<int>(
                                value: null,
                                child: Text("Error loading poojas" ,  style: TextStyle(color: Color.fromARGB(165, 158, 158, 158),fontWeight: FontWeight.w400),),
                                ),
                            ],
                            loading: () => [
                               DropdownMenuItem<int>(
                               value: null,
                               child: Text("Loading Poojas..." ,  style: TextStyle(color: Color.fromARGB(165, 158, 158, 158),fontWeight: FontWeight.w400),),
                             ),
                           ],
                           ),
                          onChanged: (value) {
                  ...
                  Padding(
                    ...
                    child: Text("Date തിരഞ്ഞെടുക്കുക",
                    style: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w700 , fontFamily: "NotoSansMalayalam"),
                    ),
                  ),
