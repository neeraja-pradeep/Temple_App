...
class DetailedView extends ConsumerWidget {
  ...
  const DetailedView({super.key, required this.bookingId});
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Payment Date: ${booking.razorpayPaymentId != null ? dateFormat.format(DateTime.parse(booking.modifiedAt ?? DateTime.now().toString())) : '-'}",
                            style: TextStyle(
                                fontSize: 12.sp,
                                fontFamily: "Poppins",
                                color: Colors.grey),
                          ...
                          // Refund Section only if cancelled
                          if (booking.status == "cancelled") ...[
                            ...
                            Text(
                              "Refund Date: ${booking.razorpayRefundId != null ? dateFormat.format(DateTime.parse(booking.modifiedAt ?? DateTime.now().toString())) : '-'}",
                              style: TextStyle(
                                  fontFamily: "Poppins",
                                  fontSize: 12.sp,
                                  color: Colors.grey),
