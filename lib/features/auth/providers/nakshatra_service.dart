...
class NakshatraService {
  static Future<List<String>> fetchNakshatras(Ref ref) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception(
          '⚠️ ${response.statusCode} ${response.body}');
    }
  }
}

final userNakshatraListProvider = FutureProvider<List<String>>((ref) async {
